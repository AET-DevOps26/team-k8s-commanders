    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // /users/{id} is an internal service-to-service endpoint that
                        // patient-service and notes-service call to compose a full profile
                        // view. The service has no published port in prod, so only callers
