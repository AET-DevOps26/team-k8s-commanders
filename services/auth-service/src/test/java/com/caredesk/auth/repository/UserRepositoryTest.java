...
@TestPropertySource(properties = {
        ...
        // The main config pins PostgreSQLDialect; this @DataJpaTest slice runs on H2.
        // Hibernate 6 tolerated the mismatch, but Hibernate 7 (Spring Boot 4) drives H2
        // with PG session commands (set client_min_messages) that H2 rejects. Let the
        // slice use the dialect matching its actual H2 database.
