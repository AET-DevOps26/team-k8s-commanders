...
import org.openapitools.model.Clinic;
...
@Validated
@Tag(name = "Clinics", description = "Clinic overview and staff management")
public interface ClinicsApi {
    ...
    String PATH_GET_CLINIC_BY_ID = "/clinics/{clinicId}";
    /**
     * GET /clinics/{clinicId} : Get clinic details
     *
     * @param clinicId  (required)
     * @return Clinic overview (status code 200)
    ...
    @Operation(
        ...
        tags = { "Clinics" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Clinic overview", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = Clinic.class)),
                @Content(mediaType = "application/problem+json", schema = @Schema(implementation = Clinic.class))
            }),
    ...
    @RequestMapping(
        ...
        value = ClinicsApi.PATH_GET_CLINIC_BY_ID,
        produces = { "application/json", "application/problem+json" }
    )
    default ResponseEntity<Clinic> getClinicById(
        @Parameter(name = "clinicId", description = "", required = true, in = ParameterIn.PATH) @PathVariable("clinicId") UUID clinicId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"address\" : \"address\", \"phoneNumber\" : \"phoneNumber\", \"name\" : \"name\", \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\" }";
    ...
    String PATH_LIST_CLINIC_STAFF = "/clinics/{clinicId}/staff";
    /**
     * GET /clinics/{clinicId}/staff : List clinic staff (paginated)
     *
     * @param clinicId  (required)
     * @param page Zero-based page index. (optional, default to 0)
     * @param size Number of items per page. (optional, default to 20)
     * @return Paginated staff list (status code 200)
     *         or The request is malformed or fails validation. (status code 400)
     *         or Authentication is required or has failed. (status code 401)
     *         or The caller is authenticated but not allowed to access the resource. (status code 403)
     *         or The requested resource does not exist. (status code 404)
     ...
     */
    @Operation(
        operationId = "listClinicStaff",
        summary = "List clinic staff (paginated)",
        tags = { "Clinics" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Paginated staff list", content = {
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = ClinicsApi.PATH_LIST_CLINIC_STAFF,
        produces = { "application/json", "application/problem+json" }
    )
    default ResponseEntity<PaginatedUserProfileResponse> listClinicStaff(
        @Parameter(name = "clinicId", description = "", required = true, in = ParameterIn.PATH) @PathVariable("clinicId") UUID clinicId,
